...
function Feature() {
  return (
    <div className="py-8 md:mx-56 bg-goodwhite text-goodblack">
      ...
      <div className="md:flex md:flex-wrap md:gap-5 justify-center text-center justify-self-center mx-2 md:mx-0">
        <div className="text-center my-2 justify-self-center bg-goodblack p-10 rounded-lg shadow-2xl md:w-1/4 cursor-pointer md:hover:scale-105 hover:shadow-2xl">
          ...
          <p className="text-goodwhite text-2xl font-light ">
            ...
            <span className="text-goodred">50 Km&apos;s</span> i&apos;ts build
            with over
