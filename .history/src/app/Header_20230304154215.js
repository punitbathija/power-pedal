    ...
    <div className="flex lg:px-10 bg-goodwhite text-goodblack lg:h-17 lg:py-12 items-center h-12 justify-between px-2 sticky">
      <nav className="flex justify-between align-middle lg:justify-around lg:items-center w-full">
        ...
        <ul
          className={
            showMenu
              ? "lg:flex gap-24 font-normal lg:static absolute lg:p-4  text-xl lg:text-2xl shadow w-fit lg:z-auto lg:opacity-100 transition-all ease-in duration-500 bg-goodwhite my-8"
