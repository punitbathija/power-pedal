...
function Feature() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <p className="className="font-semibold lg:text-xl p-4">Cowboy is designed with you in mind, crafted to the highest standard. Every custom detail is integrated seamlessly into the frame for a new form of performance.
