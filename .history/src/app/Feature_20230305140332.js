...
function Feature() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="text-center justify-self-center hover:bg-goodwhite hover:text-goodblack">
        <div className="text-center justify-self-center bg-goodblack p-10 rounded-lg shadow-2xl w-1/4 cursor-pointer">
