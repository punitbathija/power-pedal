...
function Feature() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <p className="font-semibold lg:text-xl p-4">
        <span className="text-goodred">Power Pedal Vulcun 750 </span>bike is
        designed with you in mind, crafted to the highest standard. Every custom
        detail is integrated seamlessly into the frame for a new form of
        performance.
      </p>
      <div className="lg:flex lg:flex-wrap lg:gap-5 justify-center text-center justify-self-center mx-2 ">
        <div className="text-center my-2 justify-self-center bg-goodblack p-10 rounded-lg shadow-2xl lg:w-1/4 cursor-pointer hover:scale-105 hover:shadow-2xl">
