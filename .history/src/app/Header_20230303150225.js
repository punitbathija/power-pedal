  ...
  return (
    <div className="md:flex md:px-10 bg-offwhite text-goodblack h-17">
      <nav className="flex md:justify-around md:items-center w-full">
        <div className="cursor-pointer border-2 h-15 p-2 bg-goodwhite flex gap-1 justify-start text-2xl text-justify md:items-center  hover:text-goodwhite hover:bg-goodblack duration-1000">
