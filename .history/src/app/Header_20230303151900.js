    ...
    <div className="md:flex md:px-10 bg-offwhite text-goodblack h-17">
      <nav className="flex md:justify-around md:items-center w-full">
        <ul className="md:flex gap-24 font-normal md:p-4 text-xl md:text-2xl shadow w-fit md:z-auto md:opacity-100 opacity-0">
          <div className="my-4 cursor-pointer border-2 mx-5 h-14 p-2 bg-goodwhite flex gap-1 justify-start md:text-2xl text-justify md:items-center  hover:text-goodwhite hover:bg-goodblack hover:rounded-md duration-700">
