...
function About() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <hr className="lg:flex my-12 w-[90%] text-center justify-center m-auto" />
      <div className="flex">
        <h1 className="w-1/2 font-medium lg:text-5xl text-2xl">
        ...
        <hr />
        <h1 className="w-1/2 font-medium lg:text-5xl text-2xl text-offwhite">
