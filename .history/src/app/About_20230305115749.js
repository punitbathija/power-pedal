    ...
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="lg:flex flex-col gap-8 text-center justify-self-center">
        <h1 className="w-1/2 font-medium lg:text-5xl text-2xl m-auto">
          ...
          electric. We are a team of passionate cyclists, engineers, and
          environmentalists who are dedicated to creating high-quality electric
          bikes that are both powerful and eco-friendly. Our mission is to
          empower people to take control of their transportation, reduce their
          carbon footprint, and enjoy the ride.
        </h1>
        <h1 className="w-1/2 font-medium lg:text-5xl text-2xl m-auto">
