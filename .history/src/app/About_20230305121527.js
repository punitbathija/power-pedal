  ...
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="lg:flex text-center justify-self-center">
        <h1 className="lg:w-1/2 lg:font-medium font-normal lg:text-3xl text-2xl m-auto tracking-wide">
        ...
        <br />
        <h1 className="lg:w-1/3 lg:font-medium font-normal lg:text-3xl text-2xl m-auto">
