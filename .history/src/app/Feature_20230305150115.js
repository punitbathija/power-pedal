...
function Feature() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <p className="font-semibold lg:text-2xl text-xl p-4">
      ...
      <div className="lg:flex lg:flex-wrap lg:gap-5 justify-center text-center justify-self-center mx-2 lg:mx-0">
        <div className="text-center my-2 justify-self-center bg-goodblack p-10 rounded-lg shadow-2xl lg:w-1/4 cursor-pointer lg:hover:scale-105 lg:hover:shadow-2xl">
