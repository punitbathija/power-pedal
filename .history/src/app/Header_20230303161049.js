...
function Header() {
  return (
    <div className="flex md:px-10 bg-offwhite text-goodblack md:h-17 md:py-12 items-center h-12 justify-between overflow-hidden gap-2">
      ...
      <GiHamburgerMenu
        size={40}
        className="my-4 md:hidden cursor-pointer block "
      />
    </div>
  );
}
