...
function Feature() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="lg:flex lg:flex-wrap lg:gap-5 text-center justify-self-center">
        <div className="text-center my-2 justify-self-center bg-goodblack p-10 rounded-lg shadow-2xl lg:w-1/4 cursor-pointer hover:animate-bounce">
          ...
          <p className="text-goodwhite text-2xl font-light ">
            ...
            <span className="text-goodred">25 Km's</span> i'ts build with over
