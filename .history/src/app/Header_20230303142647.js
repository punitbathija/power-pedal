...
function Header() {
  return (
    <div className="flex px-10 bg-offwhite text-goodblack h-17">
      <nav className="flex justify-start items-center w-full cursor-pointer">
        <ul className="flex gap-24 font-normal p-4 text-xl md:text-2xl">
          <li className="border-2 p-1 bg-goodwhite flex gap-1 justify-start text-2xl text-justify items-center">
