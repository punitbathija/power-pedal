  ...
  return (
    <div className="md:flex md:px-10 bg-offwhite text-goodblack md:h-17">
      <nav className="flex md:justify-around md:items-center w-full">
        <div className="md:my-4 cursor-pointer md:border-2 mx-5 h-14 md:p-2 md:bg-goodwhite flex gap-1 justify-between text-lg md:text-2xl text-justify items-center  hover:text-goodwhite hover:bg-goodblack hover:rounded-md duration-700">
