  ...
  return (
    <div className="md:flex md:px-10 bg-offwhite text-goodblack md:h-12">
      <nav className="flex md:justify-around md:items-center w-full">
        ...
        <ul className="md:flex gap-24 font-normal md:p-4 text-xl md:text-2xl shadow w-fit z-[-1] md:z-auto md:opacity-100 opacity-0 top-[-400] transition-all ease-in duration-500">
