    ...
    <div className="flex px-10 bg-offwhite text-goodblack h-17">
      <nav className="flex justify-start items-center w-full">
        <ul className="flex gap-24 font-normal p-4 text-xl md:text-2xl">
          ...
          <li className="hidden cursor-pointer md:p-2 md:text-2xl ">ABOUT</li>
          <li className="hidden cursor-pointer md:p-2 md:text-2xl ">
            FEATURES
          </li>
          <li className="hidden cursor-pointer md:p-2 md:text-2xl ">
            PRODUCTS
          </li>
          <li className="hidden cursor-pointer md:p-2 md:text-2xl ">ORDER</li>
        </ul>
      </nav>
    </div>
  );
