...
function Header() {
  return (
    <div className="md:flex md:px-10 bg-offwhite text-goodblack md:h-12">
      <nav className="z-[-1] md:z-auto top-[-400] left-0 flex md:justify-around md:items-center w-full">
