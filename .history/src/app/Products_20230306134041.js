  ...
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="text-center my-2 justify-self-center bg-offwhite p-10 rounded-lg shadow-2xl lg:w-1/2 cursor-pointer lg:hover:scale-105 hover:shadow-2xl">
        ...
        />
        <div className="flex font-semibold lg:text-xl p-4 bg-goodblack text-goodwhite w-fit rounded-full">
          <span className="bg-black rounded-full w-1" />
          <span className="bg-skin rounded-full w-1" />
          <span className="bg-olivegreen rounded-full w-1" />
        </div>
      </div>
    </div>
  );
