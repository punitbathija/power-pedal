      ...
      <nav className="flex md:justify-around md:items-center w-full">
        ...
        <ul
          className={
            showMenu
              ? "show"
              : "md:flex gap-24 font-normal z-[-1] md:static absolutemd:p-4  text-xl md:text-2xl shadow w-fit md:z-auto md:opacity-100 opacity-0 top-[-400] transition-all ease-in duration-500"
          }
        >
