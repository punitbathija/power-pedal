    ...
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="text-center my-2 justify-self-center bg-offwhite p-10 rounded-lg shadow-2xl lg:w-1/2 cursor-pointer lg:hover:scale-105 hover:shadow-2xl">
        ...
        <div className="my-4 flex flex-col gap-3 justify-center justify-items-center align-middle w-fit mx-auto text-center text-xl">
          ...
          <button className="flex justify-center text-center gap-2 align-middle justify-items-center m-auto p-2 border-none rounded-2xl text-xl font-semibold bg-goodblack text-goodwhite hover:scale-105">
