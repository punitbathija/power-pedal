...
function About() {
  return (
    <div className="py-8 lg:mx-56 mx-2 bg-goodwhite text-goodblack">
      ...
      <div className="lg:flex gap-10 text-center justify-self-center">
        <h1 className="lg:w-1/2 font-medium lg:text-3xl text-2xl m-auto tracking-wide">
        ...
        <h1 className="lg:w-1/3 font-medium lg:text-3xl text-2xl m-auto">
