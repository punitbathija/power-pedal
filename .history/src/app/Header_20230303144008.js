    ...
    <div className="flex px-10 bg-offwhite text-goodblack h-17">
      <nav className="flex justify-start items-center w-full">
        <ul className="flex gap-24 font-normal p-4 text-xl md:text-2xl">
          ...
          <li className="cursor-pointer md:p-2">ABOUT</li>
          <li className="cursor-pointer md:p-2">FEATURES</li>
          <li className="cursor-pointer md:p-2">PRODUCTS</li>
          <li className="cursor-pointer md:p-2">ORDER</li>
        </ul>
      </nav>
    </div>
  );
